            ...
            <Card className="p-8 bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <a href="mailto:n.dovlatov@kbstender.ru" className="flex items-center text-primary hover:text-primary/80 transition-colors">
                    <Mail className="h-4 w-4 mr-2" />
                    n.dovlatov@kbstender.ru
                  </a>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-8 bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <a href="mailto:p.selivanova@kbstender.ru" className="flex items-center text-primary hover:text-primary/80 transition-colors">
                    <Mail className="h-4 w-4 mr-2" />
                    p.selivanova@kbstender.ru
                  </a>
                </div>
              </div>
            </Card>
