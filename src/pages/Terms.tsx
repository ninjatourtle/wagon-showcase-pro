              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Настоящие Условия использования (далее – «Условия») регулируют отношения между ООО «КБС-ЛОГИСТИК» (далее – «Компания») и пользователем сайта (далее – «Пользователь») при использовании сайта компании и всех связанных с ним сервисов.
                  </p>
