  ...
  return <section className="relative min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 z-10 relative">
        <div className="max-w-3xl animate-fadeInUp">
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/90 mb-8 leading-relaxed">Надежный поставщик железнодорожных вагонов всех типов. Более 14 лет на рынке грузовых перевозок России</p>
          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground font-semibold px-8 py-6 text-lg shadow-strong transition-all hover:scale-105">
